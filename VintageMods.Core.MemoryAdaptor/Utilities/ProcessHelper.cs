...
namespace VintageMods.Core.MemoryAdaptor.Utilities
{
    public static class ProcessHelper
    {
        ...
        /// <returns>
        ///     A collection of type <see cref="SystemProcess" /> that represents the process resources running the specified
        ///     application or file.
        /// </returns>
        ...
        /// <summary>
        ///     Retrieves a new <see cref="SystemProcess" /> component that created the window.
        /// </summary>
        /// <param name="windowHandle">A handle to the window.</param>
        /// <returns>
        ///     A <see cref="SystemProcess" />A <see cref="SystemProcess" /> component that is associated with the specified window
        ///     handle.
        /// </returns>
        ...
        public static bool SetDebugPrivileges()
        {
            ...
            if (
                !Advapi32.OpenProcessToken(Kernel32.GetCurrentProcess(),
                    TokenObject.TOKEN_ADJUST_PRIVILEGES | TokenObject.TOKEN_QUERY, out var hToken))
                return false;
