...
namespace VintageMods.Core.MemoryAdaptor.Applied.Detours
{
    /// <summary>
    ...
    public class Detour : IComplexApplied
    {
        ...
        /// <param name="memory">The <see cref="IMemory" /> instance.</param>
        ...
        /// <summary>
        ///     Gets a value indicating if the detour should never be disabled by the AntiCheat scan logic
        /// </summary>
