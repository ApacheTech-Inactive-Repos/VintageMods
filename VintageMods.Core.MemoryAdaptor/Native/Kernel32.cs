...
namespace VintageMods.Core.MemoryAdaptor.Native
{
    public static class Kernel32
    {
        ...
        public static bool Is32BitProcess(IntPtr hProcess)
        {
            ...
            return IsWow64Process(hProcess, out var isWow64) && isWow64;
        }
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool VirtualProtectEx(SafeMemoryHandle hProcess, IntPtr lpAddress, long dwSize,
        ...
        /// </returns>
        [DllImport("kernel32.dll", SetLastError = true)]
        public static extern bool GetExitCodeThread(SafeMemoryHandle hThread, out ulong lpExitCode);
