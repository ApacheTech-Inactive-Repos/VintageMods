...
namespace VintageMods.Core.Maths.Matrix
{
    /// <summary>
    ...
    public readonly struct Matrix3d
    {
        ...
        public Matrix3d SetScale(double scale)
        {
            ...
            return new Matrix3d(m.M00 * scale, M01, M01, M10, M11 * scale, M12, M20, M21, M22 * scale);
        }
        ...
        public double GetElement(int row, int column)
        {
            switch ((row, column))
            {
                case var m00 when m00 == (0, 0): return M00;
                case var m01 when m01 == (0, 1): return M01;
                case var m02 when m02 == (0, 2): return M02;
                case var m10 when m10 == (1, 0): return M10;
                case var m11 when m11 == (1, 1): return M11;
                case var m12 when m12 == (1, 2): return M12;
                case var m20 when m20 == (2, 0): return M20;
